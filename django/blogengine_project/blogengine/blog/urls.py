...
urlpatterns = [
    ...
    path('tags/<slug>/', TagDetail.as_view(), name='tag_details_url'),
    path('tags/<slug>/update/', TagUpdate.as_view(), name='tag_update_url'),
    path('tags/<slug>/delete/', TagDelete.as_view(), name='tag_delete_url'),
]